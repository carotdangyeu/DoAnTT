...
if(isset($_POST['login']))
{
    $username = $_POST['user'];
    $password = $_POST['pass'];
    $sql_check = mysqli_query(mysqli_connect("localhost","root","","oto"),"select * from users where username = '$username'");
    ...
    {
        $sql_check2 = mysqli_query(mysqli_connect("localhost","root","","oto"),"select * from users where username = '$username' and password = '$password'");
