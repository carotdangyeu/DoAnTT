...
if(isset($_POST['login']))
{
    ...
    $sql_check = mysqli_query(mysqli_connect("localhost","root","","oto"),"select * from nguoidung where username = '$username'");
    ...
    {
        $sql_check2 = mysqli_query(mysqli_connect("localhost","root","","oto"),"select * from nguoidung where username = '$username' and password = '$password'");
