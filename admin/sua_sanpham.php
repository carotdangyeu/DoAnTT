...
<form action="update_sanpham.php?idsp=<?php echo $idsp;?>" method="post" name="frm" onsubmit="" enctype="multipart/form-data">
	<table>
            ...
            <tr>
            	<td>Hình ảnh</td><td class="img_hienthi_sp"><img src="../Uploads/shop264/images/<?=$row['hinhanh']?>" width="80" height="120"/><br /><br /><input type="file" name="hinhanh" /></td>
            </tr>
			<tr>
            ...
            <tr>
            	<td>Mã DM</td><td> 
					...
					<?php 
						...
						$rows1=mysqli_query(mysqli_connect("localhost","root","","oto"),$sql1);
