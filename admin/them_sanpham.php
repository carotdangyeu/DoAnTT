...
<?php
	...
	//	$hinhanh=$_POST['hinhanh'];
		$upload_image="../Uploads/shop264/images/";
		...
		$query=mysqli_query(mysqli_connect("localhost","root","","oto"),$insert);
		if($query) {
      ...
      <table>
            ...
            <tr>
            	<td>Mã DM</td><td>
                    ...
                    <?php
						$show = mysqli_query(mysqli_connect("localhost","root","","oto"),"SELECT * FROM danhmuc WHERE dequi=1");
						while($show1 = mysqli_fetch_array($show))
						{
							
									echo "<option value='".$show1['madm']."'> ".$show1['tendm']."</option>";
						}
                	?>
